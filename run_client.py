...
if __name__ == "__main__":
    ...
    parser.add_argument("--cert", required=True, help="Certificate file to use to connect to the 2030.5 server")
    parser.add_argument("--key", required=True, help="Key file to use to connect to the 2030.5 server")
    parser.add_argument("--cacert", required=True, help="CA Certificate file to use to connect to the 2030.5 server")
    parser.add_argument("--server", required=True, help="The 2030.5 server to connect to")
    parser.add_argument(
        "--port", default=443, type=int, help="The port to connect to the 2030.5 server on. (Default 443)"
    )
    parser.add_argument(
        "--pin", required=True, type=int, help="PIN to validate that the client is registered with the server."
    )
