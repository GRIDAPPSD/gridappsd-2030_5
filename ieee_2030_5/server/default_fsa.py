...
def create_default_fsa_with_program(config: ServerConfiguration) -> Optional[m.FunctionSetAssignments]:
    """
...
def create_device_specific_control(device_id: str, 
                                  program: m.DERProgram,
                                  control_template: Optional[m.DERControl] = None) -> m.DERControl:
    """
