...
def render_der_control_form():
    with ui.row():
        ui.input("description").classes("w-64").bind_value(current_control, "description")
    ui.separator()
    ...
    with ui.row():
        with ui.column().classes("pr-20"):
            ...
            esdelay_input = (
                ui.input("setESDelay (hundredth of a second)").bind_value(der_default, "setESDelay").props("clearable")
            )
            setESHighFreq = ui.input("setESHighFreq (hundredth of a hertz)").bind_value(der_default, "setESHighFreq")
            setESHighVolt = ui.input("setESHighVolt (hundredth of a volt)").bind_value(der_default, "setESHighVolt")
            setESLowFreq = ui.input("setESLowFreq (hundredth of a hertz)").bind_value(der_default, "setESLowFreq")
            setESLowVolt = ui.input("setESLowVolt (hundredth of a volt)").bind_value(der_default, "setESLowVolt")
            setESRampTms = ui.input("setESRampTms (hundredth of a second)").bind_value(der_default, "setESRampTms")
            setESRandomDelay = ui.input("setESRandomDelay (hundredth of a second)").bind_value(
                der_default, "setESRandomDelay"
            )
            setGradW = ui.input("setGradW (hundredth of a watt)").bind_value(der_default, "setGradW")
            setSoftGradW = ui.input("setSoftGradW (hundredth of a watt)").bind_value(der_default, "setSoftGradW")

        with ui.column().classes("pr-20"):
            ui.label("DERControlBase")

            opModConnect = ui.checkbox("opModConnect").bind_value(der_base, "opModConnect")
            opModEnergize = ui.checkbox("opModEnergize").bind_value(der_base, "opModEnergize")
            opModFixedPFAbsorbW = ui.input("opModFixedPFAbsorbW").bind_value(der_base, "opModFixedPFAbsorbW")
            opModFixedPFAbsorbW = ui.input("opModFixedPFAbsorbW").bind_value(der_base, "opModFixedPFAbsorbW")

            opModFixedPFInjectW = ui.input("opModFixedPFInjectW").bind_value(der_base, "opModFixedPFInjectW")

            opModFixedVar = ui.input("opModFixedVar").bind_value(der_base, "opModFixedVar")
            opModFixedW = ui.input("opModFixedW").bind_value(der_base, "opModFixedW")
            opModFreqDroop = ui.input("opModFreqDroop").bind_value(der_base, "opModFreqDroop")

            opModMaxLimW = ui.input("opModMaxLimW").bind_value(der_base, "opModMaxLimW")
            opModTargetVar = ui.input("opModTargetVar").bind_value(der_base, "opModTargetVar")
            opModTargetW = ui.input("opModTargetW").bind_value(der_base, "opModTargetW")
            opModVoltVar = ui.input("opModVoltVar").bind_value(der_base, "opModVoltVar")
            opModWattPF = ui.input("opModWattPF").bind_value(der_base, "opModWattPF")

            rampTms: ui.input("rampTms").bind_value(der_base, "rampTms")
        ...
        with ui.column().classes("pr-20"):
            ...
            pModFreqWatt = (
                ui.select(
                    {v.href: v.description for v in curve_type_filtered[m.CurveType.opModFreqWatt]},
                    label="pModFreqWatt",
                )
                .classes("w-64")
            ...
            opModHFRTMayTrip = (
                ui.select(
                    {v.href: v.description for v in curve_type_filtered[m.CurveType.opModHFRTMayTrip]},
                    label="opModHFRTMayTrip",
                )
                .classes("w-64")
            ...
            opModHFRTMustTrip = (
                ui.select(
                    {v.href: v.description for v in curve_type_filtered[m.CurveType.opModHFRTMustTrip]},
                    label="opModHFRTMustTrip",
                )
                .classes("w-64")
            ...
            opModHVRTMayTrip = (
                ui.select(
                    {v.href: v.description for v in curve_type_filtered[m.CurveType.opModHVRTMayTrip]},
                    label="opModHVRTMayTrip",
                )
                .classes("w-64")
            ...
            opModHVRTMustTrip = (
                ui.select(
                    {v.href: v.description for v in curve_type_filtered[m.CurveType.opModHVRTMustTrip]},
                    label="opModHVRTMustTrip",
                )
                .classes("w-64")
            ...
            opModHVRTMomentaryCessation = (
                ui.select(
                    {v.href: v.description for v in curve_type_filtered[m.CurveType.opModHVRTMomentaryCessation]},
                    label="opModHVRTMomentaryCessation",
                )
                .classes("w-64")
            ...
            opModLFRTMayTrip = (
                ui.select(
                    {v.href: v.description for v in curve_type_filtered[m.CurveType.opModLFRTMayTrip]},
                    label="opModLFRTMayTrip",
                )
                .classes("w-64")
            ...
            opModLVRTMayTrip = (
                ui.select(
                    {v.href: v.description for v in curve_type_filtered[m.CurveType.opModLVRTMayTrip]},
                    label="opModLVRTMayTrip",
                )
                .classes("w-64")
            ...
            opModLVRTMustTrip = (
                ui.select(
                    {v.href: v.description for v in curve_type_filtered[m.CurveType.opModLVRTMustTrip]},
                    label="opModLVRTMustTrip",
                )
                .classes("w-64")
            ...
            opModLVRTMomentaryCessation = (
                ui.select(
                    {v.href: v.description for v in curve_type_filtered[m.CurveType.opModLVRTMomentaryCessation]},
                    label="opModLVRTMomentaryCessation",
                )
                .classes("w-64")
...
def show_controls():
    ...
    if curve_response:
        ...
        for curve_type in m.CurveType:
            curve_type_filtered[curve_type] = [
                curve
                for curve in curve_list.DERCurve
                if curve.curveType == curve_type.name or curve.curveType == curve_type.value
            ]
